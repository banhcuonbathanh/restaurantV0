...
mixin _$HomeState {
  ...
  AsyncValue<List<FeatureProductModel>> get feartureProduct =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      AsyncValue<List<FeatureProductModel>> feartureProduct});
}
    ...
    return _then(_value.copyWith(
      ...
      feartureProduct: null == feartureProduct
          ...
          : feartureProduct // ignore: cast_nullable_to_non_nullable
              as AsyncValue<List<FeatureProductModel>>,
    ) as $Val);
  }
}
...
class _$_HomeState implements _HomeState {
  ...
  @override
  String toString() {
    return 'HomeState(banners: $banners, brands: $brands, categories: $categories, feartureProduct: $feartureProduct)';
  }
