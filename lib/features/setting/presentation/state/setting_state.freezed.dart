...
abstract class $SettingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? passCode, String? accessToken, int? userId});
}
...
class _$_SettingState implements _SettingState {
  const _$_SettingState({this.passCode, this.accessToken, this.userId});
  ...
  @override
  String toString() {
    return 'SettingState(passCode: $passCode, accessToken: $accessToken, userId: $userId)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, passCode, accessToken, userId);
...
abstract class _SettingState implements SettingState {
  const factory _SettingState(
      {final String? passCode,
      final String? accessToken,
      final int? userId}) = _$_SettingState;
